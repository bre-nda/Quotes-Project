...
export class QuoteComponent implements OnInit {
  ...
  quotes:Quote[] = [
    ...
    {id:2,description:'If you want to live a happy life, tie to a goal, not people or things',author: 'Albert Eintsen'},
    {id:3,description:'Never let the fear of striking out keep you from playing the game',author:'Babe Ruth'},
